...
cmake -DCMAKE_BUILD_TYPE=Release -DDIST_NAME="debian-12" -DDIST_DEPS="libfmt9,libfmt-dev" -DDIST_ARCH="amd64" -B build
...
cd "$ROOT_DIR"
cmake -DCMAKE_BUILD_TYPE=Release  -DDIST_NAME="debian-12" -DDIST_DEPS="libfmt9,libfmt-dev,libspdlog1.10,libspdlog-dev,catch2,libffshit (= $LIBFFSHIT_VERSION_STRIING)" -DDIST_ARCH="amd64"  -B $BUILD_DIR
